...
def run_calcos(datadir,outdir=None,dqicorr=False,delete_temp_files=True):
	...
	#    dqicorr--flag to perform DQICORR during calcos. Flagging true may increase runtime dramatically
	#    delete_temp_files--flag to delete files other than x1d that are created during CalCOS pipeline
	# OUTPUT: None
